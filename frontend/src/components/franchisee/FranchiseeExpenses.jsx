...
export default function FranchiseeExpenses({ expenses, logExpense, deleteExpense, onRefresh, setToast }) {
                    ...
                    <table className="min-w-full divide-y divide-gray-100">
                        <thead className="bg-gray-50/50">
                            <tr>
                                ...
                                <th className="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Logged By</th>
                            ...
                            {expenses.length === 0 ? (
                                ...
                                expenses.map((expense) => (
                                    <tr key={expense.expense_id} className="hover:bg-gray-50/50 transition-colors">
                                        <td className="px-6 py-4 text-sm text-gray-700">{formatDateTime(expense.expense_date) || '—'}</td>
                                        ...
                                        <td className="px-6 py-4 text-sm text-gray-500">{expense.logged_by_name || '—'}</td>
                                        <td className="px-6 py-4 text-sm text-gray-900 text-right font-medium">{formatINRDecimal(expense.amount)}</td>
