...
from app.models import (
    User, Role, UserRole, Franchisor, Franchise, Branch, BranchStatus,
    ApplicationStatus, RequestStatus, TransactionType, SaleStatus, Unit
)
...
def setup_franchise_branch(client, db_session):
    ...
    from app.models import Franchisor, Franchise, Branch, User, Role, UserRole
